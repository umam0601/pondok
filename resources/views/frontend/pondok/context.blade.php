    ...
    <div class="row">
      ...
      <div class="span8">
        ...
        <div class="comment-area">
          <div class="align-right margintop10"><a href="{{route('frontend.review')}}?pondok={{Crypt::encrypt($pondok->p_id)}}" style="font-size: 14px !important;">Tulis review disini...</a></div>
